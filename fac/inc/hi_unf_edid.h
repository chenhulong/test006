...
typedef struct hiUNF_EDID_DOLBY_CAP_S
{
    ...
    HI_UNF_EDID_DOLBY_CAPS_U unVersionCaps; /**<other caps in Dolby VSVDB. distinction between V0(u8VSVDBVersion=0) and V1(u8VSVDBVersion=1).*//**<CNcomment:Dolby的其他能力，依据Dolby VSVDB版本V0(u8VSVDBVersion=0)或V1来区分(u8VSVDBVersion=1)*/
