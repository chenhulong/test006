...
static inline int vp_usleep(unsigned int sec)
{
    struct timespec request_time;
    request_time.tv_sec = 0;
    request_time.tv_nsec = sec*1000;
    (void)nanosleep(&request_time, NULL);
    return 0;
}
...
HI_S32 RTP_AcquireES(HI_HANDLE hRTP, size_t* u32BufAddr, HI_U32* u32Len, HI_U32* u32PtsMs, HI_BOOL *bFirstFrm);
